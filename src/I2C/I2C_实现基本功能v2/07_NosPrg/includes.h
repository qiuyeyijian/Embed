...
G_VAR_PREFIX vuint8_t i2c_m1_addr;		//I2C从机地址
G_VAR_PREFIX vuint8_t i2c_m0_addr;
G_VAR_PREFIX  uint8_t gRecvBuff[100];

G_VAR_PREFIX  uint8_t  gI2CSendFlag;    // I2C发送数据标志，为1时将gRecvBuff中的字符串发送出去
G_VAR_PREFIX  uint8_t  gSuartSendFlag;  // suart发送数据标志，为1时将gRecvBuff中的字符串发送出去
